            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <i class="fa fa-money fa-fw"></i> Order List
                    </h3>
                </div>
...
<div class="table-wrapper">
	...
	<?php
				...
				$get_items = "select o.order_qty as order_qty, o.order_price as order_price, o.date as date , c.customer_name as customer_name from orders o, customer c where c.customer_id=o.c_id ORDER BY date DESC";
